...
func (nm *tenantNamespaceManager) BindClusterRoles(ctx context.Context,
...
func (nm *tenantNamespaceManager) UnbindClusterRoles(ctx context.Context,
	cluster discoveryv1alpha1.ClusterIdentity, clusterRoles ...string) error {
	namespace, err := nm.GetNamespace(cluster)
	if err != nil {
		klog.Error(err)
		return err
...
func (nm *tenantNamespaceManager) unbindClusterRole(ctx context.Context,
	namespace *v1.Namespace, clusterRole string) error {
